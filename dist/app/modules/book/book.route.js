...
router.post('/create-book', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), book_controller_1.BooksController.createBook);
router.get('/:id', book_controller_1.BooksController.getBook);
